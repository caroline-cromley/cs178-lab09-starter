...
# update the region here if your Movies table isn't in us-east-1
REGION = "us-east-1"
TABLE_NAME = "Movies"
...
def print_all_movies():
    ...
    # For large tables you'd use query() with a partition key instead —
    # but for our small dataset, scan() is perfectly fine.
    response = table.scan()
